  ...
  let s:guishade0 = "#11110f"
  let s:guishade1 = "#2e2e2b"
  let s:guishade2 = "#4a4a48"
  let s:guishade3 = "#676764"
  let s:guishade4 = "#838480"
  let s:guishade5 = "#a0a19c"
  let s:guishade6 = "#bcbdb9"
  let s:guishade7 = "#d9dad5"
  let s:guiaccent0 = "#9fa772"
  let s:guiaccent1 = "#c2ac6a"
  let s:guiaccent2 = "#9a9a92"
  let s:guiaccent3 = "#b3b7b0"
  let s:guiaccent4 = "#c2bcb8"
  let s:guiaccent5 = "#bbc2ba"
  let s:guiaccent6 = "#d9dad5"
  let s:guiaccent7 = "#979895"
  ...
  let s:ctermaccent0 = 144
  let s:ctermaccent1 = 7
  let s:ctermaccent2 = 145
  let s:ctermaccent3 = 249
  let s:ctermaccent4 = 250
  let s:ctermaccent5 = 250
  let s:ctermaccent6 = 253
  let s:ctermaccent7 = 145
